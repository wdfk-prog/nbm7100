...
![img](README.assets/wps1-1705569324912.jpg) 

![img](README.assets/wps2-1705569324912.jpg) 
...
![img](README.assets/wps3-1705569324912.jpg) 
...
![img](README.assets/wps4-1705569324912.jpg) 
...
![img](README.assets/wps5-1705569324912.jpg) 
...
l 配置为中断模式,可在进入低功耗时触发唤醒,进行激活或设置为待机模式;更加及时;
...
l 需要开启激活模式,提供大电流;否则,电池供电不足,将会降低电池电压,导致芯片欠压复位;

l 判断充电完成时,执行原流程;判断充电未完成时,将状态转入循环状态,以便进入低功耗;
...
![img](README.assets/wps6-1705569324912.png) 

### **b)** ***\*设置模式\****

l 由于芯片状态机切换要求;当芯片处于待机模式时,必需先切换为充电状态,才能切换为激活状态

![img](README.assets/wps7-1705569324912.jpg) 
...
![img](README.assets/wps8-1705569324912.png) 
...
\2. 若持续充电,导致电容电压大于电容耐压值,可能导致电容损坏,无法存储额定容量,导致激活失败,欠压复位;
...
![img](README.assets/wps9-1705569324912.jpg) 
